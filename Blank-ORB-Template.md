...
**Internal name:** 2026-08-22-2147-blank-orb-template-object  
**Object type:** system  
**File type:** system  
**Type:** ORB template (single source)  
**Status:** Live  
**Revised:** 2026-08-22-2147  
**Accountability Layer:** yes  
**Supersedes:** 2026-08-22-2020 / 1857  
...
An ORB is an **Accountability Layer** for the window. It is no longer only thin last-state. It carries four roles:
...
- → object-log / system-log (accountability; backup log on ORB update)
...
**Accountability:** On this ORB update, backup artifacts/object-log.md to Dragon-Object-History as YYYY-MM-DD-HHMM-log.md and update system-log.md (7-day pointers). Not on every write.
